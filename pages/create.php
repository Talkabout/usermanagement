...
if (isset($_POST["username"]) and $_POST["username"]) { $username = strval($_POST["username"]); }
 else { $result = "usernamerequired"; }
if (! isset($_POST["confirmpassword"]) and ! isset($_POST["newpassword"]) and ! isset($_POST["username"]) and ! isset($_POST["mail"]))
 { $result = "emptycreateform"; }

# Check the entered username for characters that our installation doesn't support
if ( $result === "" ) {
    $result = check_username_validity($username,$login_forbidden_chars);
}
...
#==============================================================================
if ( $result === "" ) {
    $result = check_password_strength( $newpassword, '', $pwd_policy_config, $username );
}
...
#==============================================================================
if ( $result === "" ) {
    $result = create_user($ldap, $username, $mail);

    if ($result === 'usercreated') {
        $result = change_password($ldap, 'cn=' . $username . ',cn=Users,dc=home,dc=intern', $newpassword, $ad_mode, $ad_options, $samba_mode, $samba_options, $shadow_options, $hash, $hash_options, 'manager', '');
        if ($result !== 'passwordchanged') {
            delete_user($ldap, $username);
        }
	else {
	    $result = 'usercreated';
	}
