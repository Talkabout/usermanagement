...
$messages['apptitle'] = "User Management";
...
$messages['wifimacaddressesinvalid'] = "Provided device id is invalid (format XX-XX-XX-XX-XX-XX, characters A,B,C,D,E,F and numbers)";
...
$messages['c'] = "Country";
$messages['cinvalid'] = "Country must be a 2 character code (EN, DE...)";
...
$messages['userworkstations'] = "Logon Workstation";
$messages['userworkstationsplaceholder'] = "WS1";
$messages['userworkstationsinvalid'] = "Wrong format for user workstation. Needs to be a workstation name in upper case.";
$messages['taborganization'] = "Organization";
